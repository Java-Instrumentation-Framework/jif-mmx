...
public class HuslConverter {
   ...
   public static float[] convertHuslToRgb(float h, float s, float l) {
      return convertLchToRgb(convertHuslToLch(new float[]{h, s, l})); 
   }

//   public float[] convertHuslToHex(float[] hsl) {
//      return convertRgbToHex(convertHuslToRgb(hsl));
//   }

//   public float[] convertRgbToHusl(float r, float g, float b) {
//      return convertLchToHusl(convertRgbToLch(r, g, b));
//   }
//
//   public float[] convertHuslpToRgb(float[] hsl) {
//      return convertLchToRgb(convertHuslpToLch(hsl));
//   }
//
//   public float[] convertHuslpToHex(float[] hsl) {
//      return convertRgbToHex(convertHuslpToRgb(hsl));
//   }

//   public float[] convertRgbToHuslp(float r, float g, float b) {
//      return convertLchToHuslp(convertRgbToLch(new float{}{r, g, b}));
//   }

   public static float[] convertLchToRgb(float[] lch) {
      return convertXyzToRgb(convertLuvToXyz(convertLchToLuv(lch)));
   }

   public static float[] convertRgbToLch(float[] rgb) {
      return convertLuvToLch(convertXyzToLuv(convertRgbToXyz(rgb))); }
   
//public float[] convertHexToHuslp(float hex) {
//      return convertRgbToHuslp(convertHexToRgb(hex));
//   }
//
//   public float[] convertHexToHusl(float hex) {
//      return convertRgbToHusl(convertHexToRgb(hex));
//   }
   ...
   /**
    * Converts an XYZ tuple to an RGB one, altering the passed array to represent the output
   ...
   /**
    * Converts an RGB tuple to an XYZ one, altering the passed array to represent the output
    * (discarding the input).
    */
   ...
   /**
    * Converts an XYZ tuple to an LUV one, altering the passed array to represent the output
    * (discarding the input).
    */
   ...
   /**
    * Converts an LUV tuple to an XYZ one, altering the passed array to represent the output
    * (discarding the input).
    */
   ...
   /**
    * Converts an LUV tuple to an LCH one, altering the passed array to represent the output
    * (discarding the input).
    */
   ...
   /**
    * Converts an LCH tuple to an LUV one, altering the passed array to represent the output
    * (discarding the input).
    */
   ...
   /**
    * Converts an HUSL tuple to an LCH one, altering the passed array to represent the output
    * (discarding the input).
    */
   ...
   /**
    * Converts an LCH tuple to an HUSL one, altering the passed array to represent the output
    * (discarding the input).
    */

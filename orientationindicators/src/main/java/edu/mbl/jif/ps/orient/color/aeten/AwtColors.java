...
import static edu.mbl.jif.ps.orient.color.aeten.Colors.HSx.HSI;
import static edu.mbl.jif.ps.orient.color.aeten.Colors.HSx.HSL;
import static edu.mbl.jif.ps.orient.color.aeten.Colors.HSx.HSV;
import static edu.mbl.jif.ps.orient.color.aeten.Colors.HSx.HSYp;
...
public class AwtColors {
	...
	public static Color fromHSI(double hue, double saturation, double intensity) {
	...
	public static Color fromHueChromaIntensity(double hue, double chroma, double intensity) {
	...
	public static Color fromLumaChromaHue(double luma, double chroma, double hue) {
	...
	public static Color fromHSYp(double hue, double chroma, double Yp) {
